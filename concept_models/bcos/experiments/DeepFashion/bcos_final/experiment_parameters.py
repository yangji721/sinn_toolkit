"""
Experiment parameters for DeepFashion experiments.
"""
import math
...
from bcos.data.transforms import RandomCutmix, RandomMixup
...
# ===================================== [ Constants ] ======================================
NUM_CLASSES = 24  # DeepFashion has 24 fashion categories
...
DEFAULT_LR_SCHEDULE = LRSchedulerFactory(
    ...
    warmup_epochs=10,  # Longer warmup for smaller dataset
    warmup_decay=0.01,
)
