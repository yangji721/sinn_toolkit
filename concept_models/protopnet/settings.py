"""Default settings for ProtoPNet."""

from .features import resnet50_features

# Network settings
base_architecture = resnet50_features
img_size = 224
num_classes = 200  # Default for CUB dataset
prototype_shape = (2000, 2048, 1, 1)  # Match ResNet50 output channels
