...
import os
_default_cache = os.path.expanduser('~/.cache/torch/hub/checkpoints')
model_dir = os.environ.get('PRETRAINED_MODEL_DIR') or (_default_cache if os.path.isdir(_default_cache) else './pretrained_models')
...
def resnet50_features_inat(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model_dict = torch.load('BBN.iNaturalist2017.res50.180epoch.best_model.pth')
